...
/**
 * Average Word Length MapReduce job driver class using ToolRunner.
 * 
 * This class demonstrates the use of ToolRunner for command-line argument
 * processing and job configuration. It calculates the average length of words
 * in text files using a MapReduce job.
 * 
 * Features:
 * - Modern Hadoop 3.x API usage
 * - ToolRunner integration for command-line processing
